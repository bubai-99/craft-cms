...
- Add GraphQL support. See [docs](https://github.com/mycompany/menu-manager/tree/main/docs/developers/graphql).
- Add custom node types. The ability to define your own custom type of nodes. See [docs](https://github.com/mycompany/menu-manager/tree/main/docs/developers/extending-elements#node-types).
