<?php
namespace mycompany\menumanager\models;
...
class Nav extends Model
{
    ...
    public function getSiteSettings(): array
    {
        ...
        $this->setSiteSettings(MenuManager::$plugin->getNavs()->getNavSiteSettings($this->id));
    ...
    {
        if ($this->maxNodes) {
            $nodesService = MenuManager::$plugin->getNodes();
            ...
            foreach ($this->maxNodesSettings as $maxNodesSetting) {
                ...
                if ($level !== null && $max !== null && $node->level) {
                    if ($node->level == $level) {
                        ...
                        foreach (MenuManager::$plugin->getNodes()->getTempNodes() as $tempNode) {
