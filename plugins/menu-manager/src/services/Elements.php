    ...
    public function getRegisteredElements($includeSources = true): array
    {
        ...
        $elements = [
            [
                ...
                'button' => Craft::t('menu-manager', 'Add an Entry'),
                'type' => Entry::class,
                'sources' => [],
                'default' => true,
                'color' => '#5e5378',
            ...
            [
                ...
                'button' => Craft::t('menu-manager', 'Add a Category'),
                'type' => Category::class,
                'sources' => [],
                'default' => true,
                'color' => '#1BB311',
            ...
            [
                ...
                'button' => Craft::t('menu-manager', 'Add an Asset'),
                'type' => Asset::class,
                'sources' => [],
                'default' => true,
                'color' => '#e12d39',
        ...
        if (Craft::$app->getPlugins()->isPluginEnabled('commerce') && class_exists(Product::class)) {
            $elements[] = [
                ...
                'button' => Craft::t('menu-manager', 'Add a Product'),
                'type' => Product::class,
                'sources' => [],
                'default' => true,
            ];
        ...
        foreach (Craft::$app->getElements()->getAllElementTypes() as $elementType) {
            if ($elementType::hasUris() && !in_array($elementType, $addedElementTypes)) {
                $elements[] = [
                    ...
                    'button' => Craft::t('menu-manager', 'Add a {name}', ['name' => $elementType::displayName()]),
                    'type' => $elementType,
                    'sources' => [],
                ];
            }
