...
use mycompany\menumanager\models\Nav as NavModel;
use mycompany\menumanager\models\Nav_SiteSettings;
use mycompany\menumanager\models\Settings;
use mycompany\menumanager\records\Nav as NavRecord;
use mycompany\menumanager\records\Nav_SiteSettings as Nav_SiteSettingsRecord;
...
class Navs extends Component
{
    ...
    public const CONFIG_NAV_KEY = 'menu-manager.navs';
    ...
    public function saveNav(NavModel $nav, bool $runValidation = true): bool
    {
        ...
        if ($runValidation && !$nav->validate()) {
            MenuManager::info('Navigation not saved due to validation error.');
            return false;
        }
        ...
        // See https://github.com/mycompany/menu-manager/issues/88
    ...
    public function handleChangedNav(ConfigEvent $event): void
    {
        ...
        try {
            ...
            $schemaVersion = Craft::$app->getProjectConfig()->get('plugins.menu-manager.schemaVersion', true);
        ...
        foreach ($registeredNodeTypes as $nodeType) {
            ...
            if ($enabled) {
                ...
                $tabs[$key] = [
                    ...
                    'button' => Craft::t('menu-manager', 'Add {name}', ['name' => $nodeType->displayName()]),
    ...
    private function _createNavQuery(): Query
    {
        $query = (new Query())
            ...
            $schemaVersion = Craft::$app->getProjectConfig()->get('plugins.menu-manager.schemaVersion');
