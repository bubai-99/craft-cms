...
// Add serializeJSON function if not available
if (!$.fn.serializeJSON) {
...
Craft.Navigation.NodeIndex = Craft.BaseElementIndex.extend({
    ...
    addNodes: function(data) {
        ...
        Craft.sendActionRequest('POST', 'menu-manager/nodes/add-nodes', { data })
            .then((response) => {
    ...
    updateParentSelect: function() {
        ...
        Craft.sendActionRequest('POST', 'menu-manager/nodes/get-parent-options', { data })
            .then((response) => {
                var html = '';
...
// Register it!
Craft.registerElementIndexClass('mycompany\\menumanager\\elements\\Node', Craft.Navigation.NodeIndex);
