<?php
namespace mycompany\menumanager\integrations;
...
class NodeFeedMeElement extends Element
{
    ...
    {
        return 'menu-manager/_integrations/feed-me/groups';
    }

    public function getColumnTemplate(): string
    {
        return 'menu-manager/_integrations/feed-me/column';
    }

    public function getMappingTemplate(): string
    {
        return 'menu-manager/_integrations/feed-me/map';
    }
