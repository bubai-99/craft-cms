...
class NodeTypeElements extends BaseField
{
    ...
    {
        return Craft::t('menu-manager', 'Node Type Fields');
    }
    ...
    public function formHtml(ElementInterface $element = null, bool $static = false): ?string
    {
        if ($element->isElement()) {
            ...
            $html .= Cp::elementSelectFieldHtml([
                'label' => Craft::t('menu-manager', 'Linked to {element}', ['element' => $typeClass]),
                'instructions' => Craft::t('menu-manager', 'The element this node is linked to.'),
                'id' => 'linkedElementId',
